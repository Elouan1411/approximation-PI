...
double get_double_0_1() { return (double)random() / INT_MAX; }
...
void create_pipes_and_forks(int NPROC, int*** tube_p, int*** tube_n,
                            pid_t** pid) {
...
void read_and_close_pipes(int i, int** tube_p, int** tube_n,
                          unsigned long* p_total, unsigned long* n_total) {
...
int main(int argc, char* argv[]) {
    ...
    unsigned long n_total = n;
    unsigned long p_total = p;
